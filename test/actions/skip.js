...
describe('skip action', function () {
    ...
    it('should throw an error given a username that does not exist', function () {
        ...
        assert.throws(() => skip(parsedCommand, usernameToIds, myUserID, events), /the user @grace does not exist/)
    });
    ...
    it('should throw an error given an event that does not exist', function () {
        ...
        assert.throws(() => skip(parsedCommand, usernameToIds, myUserID, events), /the project specified does not exist/)
    });
    ...
    it('should throw an error given an incorrect time', function () {
        ...
        assert.throws(() => skip(parsedCommand, usernameToIds, myUserID, events), /please specify the period in days e.g ...for 2 days/)
    });
});